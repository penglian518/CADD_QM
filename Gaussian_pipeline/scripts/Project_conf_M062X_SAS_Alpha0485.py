...
step1_qm_conf = {
    ...
    'Group_name': 'M062X_631+Gdp_SDD_SMD_SAS_Alpha0485',
    ...
    'SCRF_others': '',
    'SCRF_Read': True,
    'SCRF_ReadConf': 'Surface=SAS\nAlpha=0.485',
    # SCRF_ReadConf a str seperated by '\n'. e.g. 'Radii=Bondi\nSurface=SAS'
...
project_conf = {
    ...
    'Remote_calculation_folder_name': '/home/p6n/workplace/aminoAcids'
}

project_conf_sub1 = {
    'Reaction_foldername': 'reactions',
    'Reaction_dataset': 'pKa_cys.txt'
}
